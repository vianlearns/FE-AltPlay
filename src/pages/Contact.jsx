          ...
          <div className="space-y-10">
            ...
            <div className="pt-8 border-t border-white/5 space-y-4">
              ...
              <div className="flex gap-4">
                {/* Discord */}
                <a href="https://discord.gg/altplay" className="w-12 h-12 bg-surface-container-high rounded-xl flex items-center justify-center hover:bg-[#5865F2] hover:text-white transition-all border border-white/5 group">
                ...
                {/* X (Twitter) */}
                <a href="#" className="w-12 h-12 bg-surface-container-high rounded-xl flex items-center justify-center hover:bg-white hover:text-black transition-all border border-white/5">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                {/* Instagram */}
                <a href="#" className="w-12 h-12 bg-surface-container-high rounded-xl flex items-center justify-center hover:bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] hover:text-white transition-all border border-white/5">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href="#" className="w-12 h-12 bg-surface-container-high rounded-xl flex items-center justify-center hover:bg-[#FF0000] hover:text-white transition-all border border-white/5">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
